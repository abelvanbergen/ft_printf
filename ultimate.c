...
int	main(void)
{
	...
	ft_printf("<- %i \n", ft_printf("%#x, %#-7x, %+10.8i, %+u", x1, o1, i1, x3));
	printf("<- %i \n\n", printf("%#x, %#-7x, %+10.8i, %+u", x1, o1, i1, x3));
	...
	ft_printf("<- %i \n", ft_printf("%'i, %'8d, %'p, %'x", 12757, 965787, &nlptr, 286331153));
	printf("<- %i \n\n", printf("%'i, %'8d, %'p, %'x", 12757, 965787, &nlptr, 286331153));
